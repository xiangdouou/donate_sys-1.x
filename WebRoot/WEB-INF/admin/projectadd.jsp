					...
					<br>				 
				        ...
				        <form method="post" id="uploadForm" enctype="multipart/form-data">
				          	<input type="hidden" name="picture" value="uploadpic">  				        	
				       		<input type="file" class="btn btn-success" id="pic" name="pic" />   
				       		<p class="pull-right">
				        ...
				        <div class="col-xs-7">
				        	<form action="admin/projectadd" method="post">				
					        	<span>项目标题</span>
					        	<input class="form-control" name="pro_Title" type="text" placeholder="请输入项目标题" required="required">
					        	<span>募捐种类</span>
								<select class="form-control" name="pro_Type">
								<option value="1">善款</option>
								<option value="2">物品</option>
								</select>
					     	    <span>项目简介</span>
					        	<textarea rows="3" cols="3" name="pro_Des" required="required"></textarea><br>
					        	<span>募捐目标</span>
								<input class="form-control" name="pro_TargetNumber" type="text" placeholder="请输入活动募捐目标" required="required">
								<span>项目起止时间 </span>
								<p>
									<input class="form-control left" name="pro_StartTime" type="date" required="required">
									<span>至</span>
									<input class="form-control right" name="pro_EndTime" type="date" required="required">
								</p>
								<span>主办单位(执 行 方) </span>
								<input class="form-control" name="pro_Sponsor" type="text" placeholder="请输入项目执行方" required="required">
								<span>项目状态</span>
